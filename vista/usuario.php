...
<div class="page-content">
    ...
    <h4 class="text-center text-secondary">LISTA DE USUARIO</h4>
    <?php 
    include "../modelo/conexion.php";
    include "../controlador/Nuevamodificacion.php";

    $sql=$conexion->query("SELECT * from usuario")
    ?>
    <a href="elregistro.php" class="btn btn-primary btn-rounded mb-2"><i class="fa-solid fa-plus"></i> &nbsp;REGISTRAR</a>
  ...
  <tbody>
    ...
    <tr>
        ...
        <td>
            ...
            <a href="inicio.php?id=<?=$datos->id_usuario?>" onclick="advertencia(event)" class="btn btn-danger"><i class="fa-solid fa-trash"></i>
        </td>
    </tr>
